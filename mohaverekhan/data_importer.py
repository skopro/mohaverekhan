...
def import_mohaverekhan_text_tag(text_tag_id=None):
    ...
    text_content += ' کلیدها درایو درایوها درایور درایورها می‌تون بازه کننده سیستم‌عامل مولتی‌تاچ ان‌ویدیا تاچ‌پد'
    tagged_tokens += [
...
از‌نظر_E  قیمت_N  میارزه_V  ک_C  بری_V  ولی_J  واقعا_D  خفه_A  است_V  
مث_N  این_Z  ،_O  جای_N  دیگه_Z  ای_I  ندیدم_V  مشتریا_N  ش_C  انقدر_D  زیاد_A  باشه_V  ._O  
کیفیت_N  پیتزاها_N  ش_C  اصلن_N  خوب_A  نیست_V  …_O  از_E  شلوغی_A  میدون_N  تجریش_N  داره_V  پول_N  درمیاره_V  ._O  
باز_D  م_C  از_E  ش_C  خرید_N  می‌کنم_V  ،_O  بهترین_A  منطقه_N  است_V  ._O  
اگه_J  یه_U  باربری_N  اونجا_D  مشتری_N  ش_C  میشی_A  ._O  
برای_E  ارسال_N  رزومه_N  به_E  آدرس_N  job@gmail.com_M  میل_N  بزنید_V  ._O  
کتاب_N  ه_R  رو_N  تو_Z_E  فرهنگ‌سرا_N  پیدا_A  ش_C  کردم_V  ._O  کتابا_N  شون_C  م_C  واقعن_N  عالیه_A  
در‌صورت_E  مشکل_N  به_E  آیدی_N  @bitianist_S  پیام_N  بدهید_V  ._O  
حاضر_A  م_C  شرط_N  ببندم_V  همون_Z  و_J  ورداشتن_V  تزیین_N  کردن_V  و_J  برای_E  ما_Z  اووردن_V  !_O  
آخه_D  واقعا_D  درسته_A  این_T  کار_N  ؟_O  چرا_D  خب_D  درست_A  نمی‌کنن_V  ؟_O  
محیطی_A  دلباز_A  و_J  شادی_N  داره_V  دو_U  تا_L  سالن_N  بزرگ_A  هم_J  داره_V  شیشلیک_A  و_J  ماهیچه_N  و_J  گوشت_N  ش_C  هم_J  خیلی_D  خوب_A  ه_C  من_Z  غذاهای_N  دیگه_Z  ش_C  و_J  تا_E  حالا_D  تست_N  نکردم_V  
همه_T  چی_N  عالی_A  غذا_N  عالی_A  بود_V  و_J  برخورد_N  پرسنل_N  فوق‌العاده_A  مودبانه_A  بود_V  دستشویی_N  خوب_A  عالی_A  و_J  توالت_N  فوق‌العاده_A  تمیز_A  و_J  عالی_A  پذیرایی_N  عالی_A  خلاصه_A  مدیریت_N  عالی_A  فقط_D امیدوار_A  م_C  خراب_A  نشه_V  چون_J  واقعا_D  حیف_N  ه_C  
...
برخورد_N  پرسنل_N  عالی_A  …_O  کیفیت_N  غذا_N  عالی_A  …_O  قیمت_N  خوب_A  …_O  حتمنی_N  سر_N  بزنید_V  
...
ما_Z  رفتیم_V  ملورین_A  و_J  به_E  نظر_N  م_C  چیزبرگر_N  و_J  همبرگر_N  سوپریم_N  شون_C  فوق‌العاده_A  بود_V  طعم_N  گوشت_N  عالی_A  بود_V  نون_N  خوش‌طعم_A  و_J  یه_U  سس_N  تار_N  تار_N  خوشمزه_A  بعد‌از_E  مدتها_N همبرگری_Z  خوردم_V  که_J  دوست_N  داشتم_V  😍😍_X  البته_D  به_E  نظر_N  م_C  منو_N  ی_C  کافه_N  هم_J  خوب_D  بود_V  مخصوصا_D  کاپوچینو_N  و_J  کیک_N  موکا_N  ممنون_A  🙏🏻🙏🏻_X  
...
ما_Z  در_E  تاریخ_N  ۹۷/۶/۵_U  در‌قالب_E  جمع_N  دوستانه_A  و_J  همکاران_N  قدیمی_A  برای_E  شام_N  به_E  این_T  رستوران_N  رفتیم_V  ._O  انصافا_D  همه_T  چی_N  عالی_A  بود_V  ._O  کیفیت_N  غذاها_N  خوب_A  بود_V  و_J  از_E  همه_Z مهمتر_A  صبر_N  و_J  حوصله_N  کارکنان_N  بود_V  ._O  چون_J  ما_Z  عده_N  مون_N  زیاد_A  بود_V  و_J  می‌خواستیم_V  که_J  صورتحسابها_N  جدا_A  باشه_V  که_J  همین_T  طور_N  هم_J  شد_V  ._O  حجم_N  غداها_N  به_E  نسبت_N  قیمت_N خیلی_D  خوب_A  ه_C  ._O  برای_E  مثال_N  پاستا_N  پنه_N  یک_U  غذای_N  دونفره_A  هست_V  ._O  سالادها_N  رو_N  هم_J  امتحان_N  کنید_V  عالین_U  ._O  
با_E  سلام_N  اطلاعات_N  مربوط_A  به_E  cache_N  اشتباه_A  واردشده_A  است_V  ._O  ۳_U  m_L  نمی‌باشد_V  و_J  ۱۰۲۴_U  kb_L  است_V  ._O  موفق_A  باشید_V  
به_E  نظر_N  من_Z  از‌نظر_E  بدنه_N  شکی_N  در_E  این_T  مدل_N  نیست_V  چون_J  جنس_N  ش_C  از_E  کربن_N  یا_J  همون_T  فولاد_N  که_J  در_E  اینجا_D  از_E  نوع_N  سبک_N  آن_Z  استفاده‌شده_A  البته_D  سری_N  k_N  ایسوس_A  از_E آلومینیوم_N  استفاده‌شده_A  که_J  خیلی_D  زیبا_A  ست_C  و_J  در‌عین‌حال_J  که_J  کم_A  استقامت_N  دارد_V  ._O  از‌نظر_E  سخت‌افزاری_A  عین_D  k_N  هست_V  به‌جز_E  صفحه_N  نمایش_N  بزرگتر_A  و_J  استحکام_N  بالا_D  در_E  این_T  مدل_N ._O  و_J  زیبایی_N  و_J  باتری_N  قویتر_A  در_E  مدل_N  k_N  ._O  
...
سلام_R  به_E  همگی_T  مشکلات_N  :_O  -_O  من_Z  روش_N  ویندوز_N  سون_N  نصب_N  کردم_V  ،_O  رفتم_V  ۱_U  .۶_N  گیگ_N  درایور_N  سون_N  دان_N  کردم_V  ولی_J  کارت_N  گرافیکی_A  ش_C  و_J  نشناخت_V  ولی_J  ویندوز_N  ۸_U ریختم_V  مشکلی_N  نداشت_V  .(_O  البته_D  شاید_D  مشکل_N  از_E  کامل_A  نبودن_V  درایورها_N  باشه_V  )_O  -_O  صفحه_N  نمایش_N  انقدر_D  هم_J  که_J  گفته_V  می‌شه_V  بد_A  نیست_V  ولی_J  باید_V  قید_N  کارکردن_N  با_E  لپ‌تاپ_N زیر_A  نور_N  آفتاب_N  بزنید_V  مزایا_N  :_O  بقیه_N  امکانات_N  ش_C  !_O  
لپ‌تاپ_N  بی‌نقص_A  و_J  عالی_A  هست_V  من_Z  مدل_N  GT۷۰_N  عادی_A  رو_N  دارم_V  حرف_N  نداره_V  تا_J  حالا_D  نشده_V  که_J  به_E  هر_T  دلیلی_N  از_E  خرید_N  ش_C  پشیمون_A  باشم_V  چند_T  تا_L  ویژگی_N  که_J  موقع_N خرید_N  لپ‌تاپ_N  نیاز_N  هست_V  که_J  به_E  شون_N  توجه_N  کنید_V  :_O  ۱_U  ._O  گرافیک_N  و_J  cpu_N  لپ‌تاپ_N  رو_N  نمی‌تونی_V  عوض_N  کنی_V  ۲_U  ._O  اگه_J  دنبال_N  لپ‌تاپ_N  گیم_N  هستی_V  ضخامت_N  اصلا_D  واس_E  ت_C مهم_A  نباش_V  ه_C  چون_J  لپ‌تاپ_N  در_E  هر_T  صورت_N  نیاز_N  داره_V  که_J  خنک_A  شه_N  ._O  ۳_U  ._O  کیبورد_N  این_T  مدل_N  خیلی_D  خوشگل_A  ه_C  !_O  ۴_U  ._O  اگه_J  کمتر_A  می‌خوای_V  هزینه_N  کنی_V  مدل_N  GX۶۸۳_N رو_N  بخر_N  چون_D  موقع_N  کارکردن_N  با_E  این_T  دو_U  لپ‌تاپ_N  هیچ_T  تفاوتی_N  در_E  هنگام_N  پردازش_N  نمی‌بینی_V  ._O  ۵_U  ._O  یه_U  میز_N  فن_N  هم_J  برا_E  ش_C  بخر_N  ._O  من_Z  از_E  مارک_N  Deep_N  Cool_N  که_J خریدم_V  کامل_A  راضی_A  هستم_V  و_J  اون_T  رو_N  به_E  شما_Z  هم_J  توصیه_N  می‌کنم_V  ._O  
من_Z  الان_D  چندماهه_A  یکی_Z  ش_C  و_J  از_E  دیجی_N  کالا_N  خریدم_V  وزن_N  مناسب_A  در‌مقابل_E  پرتابل_N  بالای_E  اون_T  واقعا_D  منو_N  راضی_A  نگه_N  داشته_V  البته_D  دیر_D  بالا_A  اومدن_V  اون_Z  م_C  زیاد_A  به_E  چشم_N نمی‌اد_V  خیلی_D  از_E  ش_C  راضی_A  م_C 
...
# def import_correction_patterns():
#     punctuations = r'\.:!،؛؟»\]\)\}«\[\(\{\'\"…'
#     correction_patterns = (
#         (r'\.{4,}', r'.', 'replace more than 3 dots with 1 dot', 0, 'mohaverekhan', 'true'),
#         (r'( \.{2})|(\.{2} )', r' . ', 'replace exactly 2 dots with 1 dot', 0, 'mohaverekhan', 'true'),
#         (r' ?\.\.\.', r' …', 'replace 3 dots', 0, 'hazm', 'true'),
#         (r'(.)\1{1,}', r'\1', 'remove repetitions', 0, 'mohaverekhan', 'true'),
...
#         (rf'([{punctuations}])', r' \1 ', 'add extra space before and after of punctuations', 0, 'mohaverekhan', 'true'),
...
#         # (r'', r'', '', 0, 'hazm', 'true'),
#     )
#     for correction_pattern_data in correction_patterns:
#         correction_pattern = generate_correction_pattern_dictionary(
#             pattern=correction_pattern_data[0],
#             replacement=correction_pattern_data[1],
#             description=correction_pattern_data[2],
#             order=correction_pattern_data[3],
#             owner=correction_pattern_data[4],
#             is_valid=correction_pattern_data[5]
#         )
     
#         response, error = post(correction_pattern_url, correction_pattern)
#         if error:
#             return
...
# def generate_correction_pattern_dictionary(pattern, replacement, order=9999, owner=None, 
#                                                 is_valid=False, description=None):
#     d = {}
#     d['pattern'] = pattern
...
#         generate_tagged_token_dictionary('', generate_tag_dictionary(name='N')),
#         generate_tagged_token_dictionary('\\n', generate_tag_dictionary(name='N')),
# #در‌صورت_E  مشکل_N  به_E  آیدی_N  @mohaverekhan_S  پیام_N  بدهید_V  ._O  
#         generate_tagged_token_dictionary('', generate_tag_dictionary(name='N')),
#         generate_tagged_token_dictionary('', generate_tag_dictionary(name='N')),
#         generate_tagged_token_dictionary('\\n', generate_tag_dictionary(name='N')),
