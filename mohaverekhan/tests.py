...
class NormalizerViewTests(TestCase):
    ...
    def test_refinement_normalizer(self):
        ...
        normal_text_equivalents = (
            # (r'سلاااااااااااااااااااااااام چطوووووووووری؟؟', r'سلام چطوری ؟'),
            # (r'باید بریم ... اوکی؟', r'باید بریم … اوکی ؟'),
            # (r'0123456789 “كي”%?', r'۰۱۲۳۴۵۶۷۸۹ « کی » ٪ ؟'),
            # (r'مملکت ققنوس عاااالی. خوووب.. خییییلی کمااااینکه سررشته', r'مملکت ققنوس عالی . خوب . خیلی کمااینکه سررشته'),
            # (r'ستاره ی درخشان', r'ستاره‌ی درخشان'),
            # (r'می رویم', r'می‌رویم'),
            # (r'کرده ایم', r'کرده‌ایم'),
            # (r'کتاب های او را بیاورید.', r'کتاب‌های او را بیاورید .'),
            # (r'سلطه گری آن ها', r'سلطه‌گری آن‌ها'),
            # (r'نوشیدنی اش آرام کننده بود.', r'نوشیدنی اش آرام‌کننده بود .'),
            (r'فرهنگسرا فرهنگ سرا فرهنگ‌سرا', r'فرهنگسرا فرهنگسرا فرهنگسرا'),
        )
            # (r'کتاب هایمان را بیاورید.', r'کتاب‌هایمان را بیاورید.'),
            # (r'ابر کوه را دیدم.', r'ابر'),
            # (r'نوشیدنی اش آرام کنندهخوبی بود.', r'نوشیدنی اش آرام‌کننده خوبی بود .'),
            # (r'کتابمن بود.', r'کتاب من بود .'),
